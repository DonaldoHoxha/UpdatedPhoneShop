        ...
        <div class="header-top">
            ...
            <div class="user-actions">
                <div class="login-register">
                    <a href="../../login_register/login_register.html"><button class="login">Login</button></a>
                    <a href="../../login_register/login_register.html"><button class="register">SignUp</button></a>
                </div>
